...
public class GameTreeSmallTest {
  ...
  public void testAvoidLossOnCatchBlocks() {
    GameTree aGame = new GameTree("notHere.txt");  // Use a file name that does NOT exist
   
  }
 
  @Test(expected =  NullPointerException.class)
  public void testAvoidLossOnCatchBlocks2() {
    GameTree aGame = new GameTree("animal.txt"); // Use a file name that does exist
    aGame.fileName = "";
    aGame.saveGame();
